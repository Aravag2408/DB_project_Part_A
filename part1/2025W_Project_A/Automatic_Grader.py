...
if __name__ == "__main__":
    ...
    # TODO Fill in the following details
    IDS = "321771859_211545348"

    SERVER_NAME = "sqlserverdds094241course-2024w.database.windows.net"
    DATABASE_NAME = "Emiliya_Monchinski"
    USER_NAME = "Emiliya_Monchinski"
    PASSWORD = "Qwerty12!"
    ...
    TABLES_COLS = {'Contacts': ['name', 'phone', 'city'],
                   'CommonContacts': ['contactSaver', 'savedContact', 'nickname'],
                   'Attendance': ['date', 'contactName', 'delay']}
    TABLES = list(TABLES_COLS.keys())
    NUMBER_OF_TESTS = 1
    QUERY_NUMBERS = [3, 4]
    QUERY_RESULT_TYPES = {3: 'list', 4: 'set'}  # We use list for queries with ORDER BY, otherwise use set
    QUERIES_RESULT_COLUMNS = {3: ['date'],
                              4: ['name', 'FirstMeetingDate']}
